...
var creatorList = ['@PutraMtp','@alpha'];
...
router.get('/addapikey', (req, res, next) => {
    ...
    if (apikey != 'PutraBotz') return res.json(loghandler.invalidKey)
...
router.get('/tiktod', async (req, res, next) => {
	...
	if(!apikeyInput) return res.json(loghandler.notparam)
	if(apikeyInput != 'PutraBotz') return res.json(loghandler.invalidKey)
...
router.get('/quran', async (req, res, next) => {
	...
	if(!apikeyInput) return res.json(loghandler.notparam)
	if(apikeyInput != 'PutraBitz') return res.json(loghandler.invalidKey)
...
router.get('/filmapik/play', async (req, res, next) => {
	...
	if(!apikeyInput) return res.json(loghandler.notparam)
	if(apikeyInput != 'Putra Botz') return res.json(loghandler.invalidKey)
